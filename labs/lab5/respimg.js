/* 
	...
	(*) Trường Đại học Công nghệ, ĐHQGHN (http://uet.vnu.edu.vn)
	(**) iTest (http://itest.com.vn)
 */
function createImg() {
...
function loadImg() {
	let box = document.querySelectorAll("image-box");
	let img = document.querySelectorAll("image-box img");
	let src = document.querySelectorAll("image-box input[type=hidden]");
